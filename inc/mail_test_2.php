...
if ( isset($_REQUEST['sendemail']) ) {
	...
	if ( $_REQUEST['sendmethod'] == "mail" ) {
	    $headers = "From: form@new.chilogisticsinc.com" . "\r\n" .
                "Reply-To: " . $toemail;
		$result = mail('mike@chilogisticsinc.com', $subject, $message, $headers);
		if ( $result ) {
			echo 'OK';
		} else {
			echo 'FAIL';
...
<form class="form" id="mailform" name="mailform">
    <p>Send Us a <span style="color: orange;">Message</span></p>
	<input placeholder="Your email address" class="form-input finput" value="" name="toemail" type="text">
	<input placeholder="Your First and Last name" class="form-input finput" value="" name="from" type="text">
	<input class="form-input finput" name="subject" type="text" disabled>
	<span>Auto Subject</span>
	<input placeholder="Auto Subject" class="form-input finput" type="checkbox" onchange="AutoSubject();" name="autosubject" checked style="display:inline;"><br>
	<textarea name="message" rows="10" cols="50">
	</textarea><br />
	<input class="fbtn" type="submit" id="sendemail" onclick="GoSend(); AutoSubject();" value="Send">
...
<script>
  ...
  function AutoSubject() {
      ...
      var koopId = "<?php echo $_POST['truckID'] ?>";
  	if ( document.mailform.autosubject.checked ) {
  		document.mailform.subject.disabled=true;
  		document.mailform.subject.value='Inquiry about the truck ' + koopId;
  	} else {
